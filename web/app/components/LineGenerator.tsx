...
import { GenerateFakeLine, GenerateLine, UpdateRoster } from "./actions";
...
export default function LineGenerator() {
  ...
  return (
    <Stack padding={1} spacing={1}>
      ...
      <Stack>
        <Box border={2} borderColor={"primary.main"} padding={1}><Typography color="primary.main" variant="h5">O Line</Typography></Box>
      ...
      <Stack>
        <Box border={2} borderColor={"primary.main"} padding={1}><Typography color="primary.main" variant="h5">D Line</Typography></Box>
